...
function checkWinner(avgDolphins, avgKoalas) {
    avgDolphins * 2 < avgKoalas ? console.log(`Koalas win! ${avgKoalas} vs. ${avgDolphins}`) : console.log(`Dolphins win! ${avgDolphins} vs. ${avgKoalas}`);
    return checkWinner;
}
...
console.log(`Tips: ${tip}, Total: ${totals}`);
...
console.log(`Average amount: ${calcAverages(totals)}`);